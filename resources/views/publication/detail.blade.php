                                ...
                                <div class="card-body">
                                    <div class="d-flex align-items-center" style="padding-top: 20px;">
                                        <div class="news">
                                            <div class="post-item clearfix">
                                                <img src="{{ url('fotoPerfil/' . Auth::user()->fotoPerfil) }}" alt="">
                                                <h4><a href="#">{{ $getPublication->user->alias }}</a></h4>
                                    ...
                                    <div class="row justify-content-md-right">
                                        ...
                                        <div class="col col-lg-2">
                                            ...
                                            <a href="{{ route('publicationDetail', ['publicationId' => $getPublication->id]) }}" class="btn btn-primary">Comentarios ({{ count($getPublication->comment) }})</a>
                                        </div>
                                    </div>
                                    <br>
                                    <div id="" class="classCajaCometarios">
                                        <form action="{{ route('comentarioSave') }}" method="POST"
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Escribe tu Comentario" name="comentPublication">
